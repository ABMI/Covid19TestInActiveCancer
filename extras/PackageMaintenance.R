...
OhdsiRTools::checkUsagePackage("Covid19TestInActiveCancer")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19TestInActiveCancer.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19TestInActiveCancer.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "Covid19TestInActiveCancer")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Covid19TestInActiveCancer")
