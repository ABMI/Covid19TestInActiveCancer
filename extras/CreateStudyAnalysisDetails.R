...
covarSettings$mediumTermStartDays <- -90
covarSettings$longTermStartDays <- -180
...
oneToOneMatchByPsArgs <- CohortMethod::createMatchOnPsArgs(
  maxRatio = 1 # TODO Allow for multiple matches
)

variableRatioMatchByPsArgs <- CohortMethod::createMatchOnPsArgs(
...
# Analysis 4 -- minimal variable-ratio PS matching
...
cmAnalysisList <- list(cmAnalysis1,cmAnalysis3,cmAnalysis4,cmAnalysis7)
