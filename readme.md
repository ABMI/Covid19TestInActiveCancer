...
2. In `R`, use the following `devtools` command to install the Covid19TestInActiveCancer package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(Covid19TestInActiveCancer)
	...
	outputFolder <- "c:/Covid19TestInActiveCancer"
...
License
=======
The Covid19TestInActiveCancer package is licensed under Apache License 2.0

Development
===========
Covid19TestInActiveCancer was developed in ATLAS and R Studio.
